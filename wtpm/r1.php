...
<div id="mainContainer">
  ...
  <div class="abaContainer">
    ...
    <div class="abaConteudo" id="maquinaAbaConteudo2">
      <iframe src="turing_client.html" style="width: 100%; height:100%;" ></iframe>
    </div>
    <div class="abaConteudo" id="maquinaAbaConteudo1">
      <iframe src="tpm_gg_client.html" style="width: 100%; height:100%;" ></iframe>
    </div>
  </div>
  <input type="submit" value="<?  echo(($load_id !== null) ? "Gerar Nova Versão da Máquina" : "Salvar Máquina");?>" id="btUpdateMachine" />
</form>
</body>
</html>
