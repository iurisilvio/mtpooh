...
<div id="mainContainer">
  ...
  <textarea name="name" rows="1" style="width: 1000px; font-family: monospace;"><?php if (!is_null($loaded_name)) echo htmlspecialchars($loaded_name); ?></textarea><br />
  <div>Breve comentário (também para identificação):</div>
  <textarea name="comment" rows="1" style="width: 1000px; font-family: monospace;"><?php if (!is_null($loaded_comment)) echo htmlspecialchars($loaded_comment); ?></textarea><br />
  ...
  <div class="abaContainer">
    <div class="abaConteudoAtiva" id="maquinaAbaConteudo0">
      <textarea id="machine" name="machine" style="width: 1000px; height: 100%; font-family: monospace;"><?php if (!is_null($loaded_machine)) echo htmlspecialchars($loaded_machine); ?></textarea>
    </div>
  ...
  <textarea name="input" rows="1" style="width: 1000px; font-family: monospace;"><?php if (!is_null($loaded_input)) echo htmlspecialchars($loaded_input); ?></textarea><br />
  <input type="submit" />
